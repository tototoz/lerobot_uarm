...
from .config_fairino import fairinoConfig
import rclpy
...
try:
    from lerobot.teleoperators.uarm.uarm import get_uarm_gripper_state
except ImportError:
    # 如果还没启动 uarm，就先用 0 占位
    def get_uarm_gripper_state():
        return 0.0
        
class fairino(Robot, Node):  # 同时继承 Robot 和 Node
    ...
    def __init__(self, config: fairinoConfig):
        ...
        # 首先初始化 Node
        Node.__init__(self, "fairino_node")  # 初始化 ROS2 节点
        ...
        # 使用最兼容的 QoS 设置 - 尝试匹配 servo2fairino.py 的发布设置
        # 默认 QoS（通常为可靠传输）
    ...
    def listener_callback(self, msg):
        ...
        self.bus["gripper"] = get_uarm_gripper_state()
    ...
    def get_observation(self) -> dict[str, Any]:
        ...
        self.bus = {
            ...
            "Joint5": self.joint_angles[4],
            "Joint6": self.joint_angles[5],
            "gripper": get_uarm_gripper_state(),  
        }
